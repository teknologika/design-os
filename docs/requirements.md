...
- **An AI coding assistant** — Design OS uses slash commands to guide the design process. Use any tool that supports custom commands or prompts (Cursor, Windsurf, Codex, etc.).
